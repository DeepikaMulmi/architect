		...
		if ( ! empty( $include_option ) && in_array( 'vertical', $include_option, true ) ) {
			$this->set_option(
				array(
					'field_type' => 'select',
					'name'       => 'direction',
					'title'      => esc_html__( 'Vertical Slider', 'qi-addons-for-elementor' ),
					'options'    => array(
			...
			$this->set_option(
				array(
					...
					'title'         => esc_html__( 'Enable Focus When in Viewport', 'qi-addons-for-elementor-premium' ),
			...
			if ( empty( $exclude_option ) || ! in_array( 'slider_navigation_arrows_style', $exclude_option, true ) ) {
				...
				$this->set_option(
					array(
						...
						'title'      => esc_html__( 'Navigation Holder Width', 'qi-addons-for-elementor-premium' ),
						'size_units' => array( 'px', '%', 'em' ),
						'range'      => array(
							'px' => array(
								'min' => 0,
				...
				$this->set_option(
					array(
						...
						'title'      => esc_html__( 'Navigation Holder Height', 'qi-addons-for-elementor-premium' ),
						'size_units' => array( 'px', '%', 'em' ),
						'range'      => array(
							'px' => array(
								'min' => 0,
				...
				$this->set_option(
					array(
						...
						'title'      => esc_html__( 'Navigation Background Color', 'qi-addons-for-elementor-premium' ),
						'dependency' => array(
							'relation' => 'or',
							'hide'     => array(
								'slider_navigation'          => array(
				...
				$this->set_option(
					array(
						...
						'title'      => esc_html__( 'Navigation Border', 'qi-addons-for-elementor-premium' ),
						'dependency' => array(
							'relation' => 'or',
							'hide'     => array(
								'slider_navigation'          => array(
				...
				$this->set_option(
					array(
						...
						'title'      => esc_html__( 'Navigation Border Radius', 'qi-addons-for-elementor-premium' ),
						'size_units' => array( 'px', '%' ),
						'responsive' => true,
						'dependency' => array(
							'relation' => 'or',
			...
			if ( empty( $exclude_option ) || ! in_array( 'slider_pagination_style', $exclude_option, true ) ) {
				$this->set_option(
					array(
						...
						'title'         => esc_html__( 'Enable Numbers', 'qi-addons-for-elementor-premium' ),
						'options'       => qi_addons_for_elementor_get_select_type_options_pool( 'yes_no', false ),
						'default_value' => 'no',
						'dependency'    => array(
							'hide' => array(
				...
				$this->set_option(
					array(
						...
						'title'      => esc_html__( 'Numbers Color', 'qi-addons-for-elementor-premium' ),
						'selectors'  => array(
							'{{WRAPPER}} .qodef--pagination-numbers+.swiper-pagination-bullets .swiper-pagination-bullet:before, {{WRAPPER}} .qodef--pagination-numbers>.swiper-pagination-bullets .swiper-pagination-bullet:before' => 'color: {{VALUE}};',
						),
						'group'      => esc_html__( 'Slider Pagination Style', 'qi-addons-for-elementor' ),
					)
				);
				$this->set_option(
					array(
						...
						'title'      => esc_html__( 'Numbers Typography', 'qi-addons-for-elementor-premium' ),
						'dependency' => array(
							'hide' => array(
				...
				$this->set_option(
					array(
						...
						'selectors'  => array(
							...
							'{{WRAPPER}} .swiper-container-vertical+.qodef-swiper-pagination-outside.swiper-pagination .swiper-pagination-bullet' => 'margin: {{SIZE}}{{UNIT}} 0;',
						),
						'dependency' => array(
							'hide' => array(
								'slider_pagination' => array(
