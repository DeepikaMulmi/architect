...
if ( class_exists( 'QiAddonsForElementor_Shortcode' ) ) {
	class QiAddonsForElementor_Table_Of_Contents_Shortcode extends QiAddonsForElementor_Shortcode {
		...
		public function map_shortcode() {
			...
			$this->set_documentation( 'https://qodeinteractive.com/qi-addons-for-elementor/documentation/#2_table_of_contents' );
			$this->set_option(
				array(
					'field_type' => 'text',
					'name'       => 'custom_class',
			...
			$this->set_option(
				array(
					...
					'options'       => array(
						'no'  => esc_html__( 'No', 'qo-addons-for-elementor' ),
						'yes' => esc_html__( 'Yes', 'qo-addons-for-elementor' ),
					),
					'default_value' => 'no',
				)
			);
