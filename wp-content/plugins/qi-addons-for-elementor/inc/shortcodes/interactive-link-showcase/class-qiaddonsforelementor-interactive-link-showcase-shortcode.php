...
if ( class_exists( 'QiAddonsForElementor_Shortcode' ) ) {
	class QiAddonsForElementor_Interactive_Link_Showcase_Shortcode extends QiAddonsForElementor_Shortcode {
		...
		public function map_shortcode() {
			...
			$this->set_documentation( 'https://qodeinteractive.com/qi-addons-for-elementor/documentation/#6_interactive_links' );
			$this->set_option(
				array(
					'field_type' => 'text',
					'name'       => 'custom_class',
				...
				array(
					...
					'items'         => array(
						...
						array(
							...
							'description' => esc_html__( 'This option affects only inline layout', 'qi-addons-for-elementor' ),
						),
					),
				)
			);
