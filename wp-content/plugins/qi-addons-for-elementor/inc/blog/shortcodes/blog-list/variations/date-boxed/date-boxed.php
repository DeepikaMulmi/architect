...
if ( ! function_exists( 'qi_addons_for_elementor_add_blog_list_variation_date_boxed' ) ) {
	/**
	 ...
	 * @return array
	 */
	function qi_addons_for_elementor_add_blog_list_variation_date_boxed( $variations ) {
		$variations['date-boxed'] = esc_html__( 'Date Boxed', 'qi-addons-for-elementor' );

		return $variations;
	}

	add_filter( 'qi_addons_for_elementor_filter_blog_list_layouts', 'qi_addons_for_elementor_add_blog_list_variation_date_boxed' );
}

if ( ! function_exists( 'qi_addons_for_elementor_load_blog_list_variation_date_boxed_assets' ) ) {
	/**
	 ...
	 * @return bool
	 */
	function qi_addons_for_elementor_load_blog_list_variation_date_boxed_assets( $is_enabled, $params ) {
	...
	add_filter( 'qi_addons_for_elementor_filter_load_blog_list_assets', 'qi_addons_for_elementor_load_blog_list_variation_date_boxed_assets', 10, 2 );
}

if ( ! function_exists( 'qi_addons_for_elementor_register_blog_list_date_boxed_scripts' ) ) {
	/**
	 ...
	 * @return array
	 */
	function qi_addons_for_elementor_register_blog_list_date_boxed_scripts( $scripts ) {
	...
	add_filter( 'qi_addons_for_elementor_filter_blog_list_register_scripts', 'qi_addons_for_elementor_register_blog_list_date_boxed_scripts' );
}

if ( ! function_exists( 'qi_addons_for_elementor_register_blog_list_date_boxed_styles' ) ) {
	/**
	 * Function that register modules 3rd party scripts
	 *
	 * @param array $styles
	 ...
	 * @return array
	 */
	function qi_addons_for_elementor_register_blog_list_date_boxed_styles( $styles ) {
	...
	add_filter( 'qi_addons_for_elementor_filter_blog_list_register_styles', 'qi_addons_for_elementor_register_blog_list_date_boxed_styles' );
}

if ( ! function_exists( 'qi_addons_for_elementor_add_blog_list_options_date_boxed' ) ) {
	function qi_addons_for_elementor_add_blog_list_options_date_boxed( $options ) {
	...
	add_filter( 'qi_addons_for_elementor_filter_blog_list_extra_options', 'qi_addons_for_elementor_add_blog_list_options_date_boxed' );
}
