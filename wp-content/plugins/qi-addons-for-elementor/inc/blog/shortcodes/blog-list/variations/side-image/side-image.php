...
if ( ! function_exists( 'qi_addons_for_elementor_add_blog_list_side_image_hide_excerpt' ) ) {
	/**
	 ...
	 * @return array
	 */
	function qi_addons_for_elementor_add_blog_list_side_image_hide_excerpt( $layouts ) {
		$layouts['side-image'] = 'side-image';

		return $layouts;
	}

	add_filter( 'qi_addons_for_elementor_filter_blog_list_layout_hide_excerpt', 'qi_addons_for_elementor_add_blog_list_side_image_hide_excerpt' );
}
