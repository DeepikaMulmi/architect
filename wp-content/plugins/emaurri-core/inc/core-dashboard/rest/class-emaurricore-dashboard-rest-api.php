...
if ( ! class_exists( 'EmaurriCore_Dashboard_Rest_API' ) ) {
	 ...
	 */
	class EmaurriCore_Dashboard_Rest_API {
		...
		public function __construct() {
			...
			add_filter( 'emaurri_core_filter_dashboard_js_global_variables', array( $this, 'localize_script' ) );
		...
		/**
		 * @return EmaurriCore_Dashboard_Rest_API
		 */
	...
	EmaurriCore_Dashboard_Rest_API::get_instance();
}
