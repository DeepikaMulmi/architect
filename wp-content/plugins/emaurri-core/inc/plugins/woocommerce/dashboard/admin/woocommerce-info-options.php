...
if ( ! function_exists( 'emaurri_coreadd_product_info_typography_options' ) ) {
	/**
	 * Function that add general options for this module
	 *
	 * @param object $page
	 */
	function emaurri_coreadd_product_info_typography_options( $page ) {
		...
		if ( $page ) {
			$product_info_tab = $page->add_tab_element(
				array(
					...
					'icon'        => 'fa fa-cog',
					'title'       => esc_html__( 'Product Info', 'emaurri-core' ),
					'description' => esc_html__( 'Set typography values for product info elements', 'emaurri-core' ),
				)
			);
			...
			$price_typography_section = $product_info_tab->add_section_element(
				array(
					...
					'title' => esc_html__( 'Price Typography', 'emaurri-core' ),
				)
			);
			...
			$product_price_typography_row = $price_typography_section->add_row_element(
				array(
					...
					'title' => esc_html__( 'Product Price Styles', 'emaurri-core' ),
				)
			);
			...
			$product_price_typography_row->add_field_element(
				array(
					...
					'title'      => esc_html__( 'Discount Color', 'emaurri-core' ),
					'args'       => array(
						'col_width' => 3,
					),
				)
			...
			$product_price_typography_row->add_field_element(
				array(
					...
					'options'    => emaurri_coreget_select_type_options_pool( 'font_weight' ),
					'args'       => array(
						'col_width' => 3,
					),
				)
			...
			$product_price_typography_row->add_field_element(
				array(
					...
					'options'    => emaurri_coreget_select_type_options_pool( 'text_transform' ),
					'args'       => array(
						'col_width' => 3,
					),
				)
			...
			$product_price_typography_row->add_field_element(
				array(
					...
					'options'    => emaurri_coreget_select_type_options_pool( 'font_style' ),
					'args'       => array(
						'col_width' => 3,
					),
				)
			...
			$product_price_typography_row->add_field_element(
				array(
					...
					'options'    => emaurri_coreget_select_type_options_pool( 'text_decoration' ),
					'args'       => array(
						'col_width' => 3,
					),
				)
			...
			$product_single_price_typography_row = $price_typography_section->add_row_element(
				array(
					...
					'title' => esc_html__( 'Product Single Price Styles', 'emaurri-core' ),
				)
			);
			...
			$product_info_typography_section = $product_info_tab->add_section_element(
				array(
					...
					'title' => esc_html__( 'Product Info Typography', 'emaurri-core' ),
				)
			);
			...
			$product_label_typography_row = $product_info_typography_section->add_row_element(
				array(
					...
					'title' => esc_html__( 'Product Info Label Styles', 'emaurri-core' ),
				)
			);
			...
			$product_info_typography_row = $product_info_typography_section->add_row_element(
				array(
					...
					'title' => esc_html__( 'Product Info Styles', 'emaurri-core' ),
				)
			);
			...
			$product_info_link_typography_row = $product_info_typography_section->add_row_element(
				array(
					...
					'title' => esc_html__( 'Product Info Link Styles', 'emaurri-core' ),
				)
			);
	...
	add_action( 'emaurri_coreaction_after_woo_options_map', 'emaurri_coreadd_product_info_typography_options' );
}
