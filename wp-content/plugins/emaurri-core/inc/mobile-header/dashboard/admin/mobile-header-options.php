...
if ( ! function_exists( 'emaurri_core_add_mobile_header_options' ) ) {
	/**
	 * Function that add general options for this module
	 */
	function emaurri_core_add_mobile_header_options() {
		...
		$page = $qode_framework->add_options_page(
			array(
				...
				'slug'        => 'mobile-header',
				'icon'        => 'fa fa-cog',
				'title'       => esc_html__( 'Mobile Header', 'emaurri-core' ),
				'description' => esc_html__( 'Global Mobile Header Options', 'emaurri-core' ),
			)
		);
		...
		if ( $page ) {
			...
			$general_tab->add_field_element(
				array(
					...
					'title'         => esc_html__( 'Sticky Mobile Header', 'emaurri-core' ),
					'description'   => esc_html__( 'Set mobile header to be sticky', 'emaurri-core' ),
				)
			);
			...
			$general_tab->add_field_element(
				array(
					...
					'default_value' => apply_filters( 'emaurri_core_filter_mobile_header_layout_default_option', '' ),
					'options'       => apply_filters( 'emaurri_core_filter_mobile_header_layout_option', array() ),
				)
			);
			...
			$section_svg_path->add_field_element(
				array(
					...
					'title'       => esc_html__( 'Mobile Menu Open Icon SVG Path', 'emaurri-core' ),
			...
			$section_svg_path->add_field_element(
				array(
					...
					'title'       => esc_html__( 'Mobile Menu Close Icon SVG Path', 'emaurri-core' ),
			...
			$opener_section = $general_tab->add_section_element(
				array(
					...
					'title' => esc_html__( 'Mobile Header Opener Styles', 'emaurri-core' ),
				)
			);
			...
			$opener_section_row->add_field_element(
				array(
					...
					'title'      => esc_html__( 'Hover/Active Color', 'emaurri-core' ),
					'args'       => array(
						'col_width' => 3,
					),
				)
			...
			do_action( 'emaurri_core_action_after_mobile_header_options_map', $page, $general_tab );
		}
	}

	add_action( 'emaurri_core_action_default_options_init', 'emaurri_core_add_mobile_header_options', emaurri_core_get_admin_options_map_position( 'mobile-header' ) );
}
