...
if ( ! function_exists( 'emaurri_core_add_elegant_icons_to_collection' ) ) {
	/**
	 ...
	 * @return array
	 */
	function emaurri_core_add_elegant_icons_to_collection( $icons ) {
		$icons[] = 'EmaurriCore_Elegant_Icons_Pack';

		return $icons;
	}

	add_filter( 'qode_framework_filter_add_icon', 'emaurri_core_add_elegant_icons_to_collection' );
}

if ( class_exists( 'QodeFrameworkIconPack' ) ) {
	class EmaurriCore_Elegant_Icons_Pack extends QodeFrameworkIconPack {
