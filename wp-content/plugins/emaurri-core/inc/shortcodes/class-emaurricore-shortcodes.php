...
if ( ! class_exists( 'EmaurriCore_Shortcodes' ) ) {
	class EmaurriCore_Shortcodes {
		...
		function init() {
			...
			include_once EMAURRI_CORE_SHORTCODES_PATH . '/dashboard/customizer/shortcodes-customizer-options.php';
		}
		...
		function include_shortcode_classes() {
			include_once EMAURRI_CORE_SHORTCODES_PATH . '/class-emaurricore-shortcode.php';
			include_once EMAURRI_CORE_SHORTCODES_PATH . '/class-emaurricore-list-shortcode.php';
		}
		...
		function register_shortcodes() {
			...
			$shortcodes     = apply_filters( 'emaurri_core_filter_register_shortcodes', $shortcodes = array() );
	...
	EmaurriCore_Shortcodes::get_instance();
}
