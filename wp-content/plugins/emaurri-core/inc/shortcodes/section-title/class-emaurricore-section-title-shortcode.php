...
if ( ! function_exists( 'emaurri_core_add_section_title_shortcode' ) ) {
	/**
	 ...
	 * @return array
	 */
	function emaurri_core_add_section_title_shortcode( $shortcodes ) {
		$shortcodes[] = 'EmaurriCore_Section_Title_Shortcode';

		return $shortcodes;
	}

	add_filter( 'emaurri_core_filter_register_shortcodes', 'emaurri_core_add_section_title_shortcode' );
}

if ( class_exists( 'EmaurriCore_Shortcode' ) ) {
	class EmaurriCore_Section_Title_Shortcode extends EmaurriCore_Shortcode {

		public function map_shortcode() {
			$this->set_shortcode_path( EMAURRI_CORE_SHORTCODES_URL_PATH . '/section-title' );
			$this->set_base( 'emaurri_core_section_title' );
			$this->set_name( esc_html__( 'Section Title', 'emaurri-core' ) );
			$this->set_description( esc_html__( 'Shortcode that adds section title element', 'emaurri-core' ) );
			...
			$this->set_option(
				array(
					'field_type' => 'text',
					'name'       => 'link',
					'title'      => esc_html__( 'Title Custom Link', 'emaurri-core' ),
					'group'      => esc_html__( 'Title Style', 'emaurri-core' ),
				)
			);
			$this->set_option(
			...
			$this->set_option(
				array(
					'field_type' => 'text',
					'name'       => 'tagline',
					'title'      => esc_html__( 'Tagline', 'emaurri-core' ),
				)
			);
			$this->set_option(
				array(
					'field_type' => 'color',
					'name'       => 'tagline_color',
					'title'      => esc_html__( 'Tagline Color', 'emaurri-core' ),
					'group'      => esc_html__( 'Tagline Style', 'emaurri-core' ),
				)
			);
			$this->set_option(
				array(
					...
					'title'      => esc_html__( 'Tagline Margin Bottom', 'emaurri-core' ),
					'group'      => esc_html__( 'Tagline Style', 'emaurri-core' ),
				)
			);
		}
		...
		public function render( $options, $content = null ) {
			...
			return emaurri_core_get_template_part( 'shortcodes/section-title', 'templates/section-title', '', $atts );
		}
