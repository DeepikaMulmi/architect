...
if ( ! function_exists( 'emaurri_core_add_portfolio_archive_list_options' ) ) {
	/**
	 * Function that add list options for portfolio archive module
	 */
	function emaurri_core_add_portfolio_archive_list_options( $tab ) {
		$list_item_layouts = apply_filters( 'emaurri_core_filter_portfolio_list_layouts', array() );
		...
		if ( $tab ) {
			$tab->add_field_element(
				array(
					...
					'description'   => esc_html__( 'Choose layout for list item on archive lists', 'emaurri-core' ),
			...
			$tab->add_field_element(
				array(
					...
					'description' => esc_html__( 'Choose an appearance style for archive lists', 'emaurri-core' ),
			...
			$tab->add_field_element(
				array(
					...
					'title'       => esc_html__( 'Masonry Image Proportions', 'emaurri-core' ),
					'description' => esc_html__( 'Choose image proportions for archive lists', 'emaurri-core' ),
					'options'     => array(
			...
			$tab->add_field_element(
				array(
					...
					'description' => esc_html__( 'Choose number of columns for archive lists', 'emaurri-core' ),
			...
			$tab->add_field_element(
				array(
					...
					'description' => esc_html__( 'Choose space between items for archive lists', 'emaurri-core' ),
			...
			$tab->add_field_element(
				array(
					...
					'description'   => esc_html__( 'Choose number of columns for screens between 1367 and 1440 px for archive lists', 'emaurri-core' ),
					'default_value' => '3',
					'options'       => emaurri_core_get_select_type_options_pool( 'columns_number' ),
					'dependency'    => array(
						'show' => array(
			...
			$tab->add_field_element(
				array(
					...
					'description'   => esc_html__( 'Choose number of columns for screens between 1025 and 1366 px for archive lists', 'emaurri-core' ),
					'default_value' => '3',
					'options'       => emaurri_core_get_select_type_options_pool( 'columns_number' ),
					'dependency'    => array(
						'show' => array(
			...
			$tab->add_field_element(
				array(
					...
					'description'   => esc_html__( 'Choose number of columns for screens between 769 and 1024 px for archive lists', 'emaurri-core' ),
					'default_value' => '3',
					'options'       => emaurri_core_get_select_type_options_pool( 'columns_number' ),
					'dependency'    => array(
						'show' => array(
			...
			$tab->add_field_element(
				array(
					...
					'description'   => esc_html__( 'Choose number of columns for screens between 681 and 768 px for archive lists', 'emaurri-core' ),
					'default_value' => '3',
					'options'       => emaurri_core_get_select_type_options_pool( 'columns_number' ),
					'dependency'    => array(
						'show' => array(
			...
			$tab->add_field_element(
				array(
					...
					'description'   => esc_html__( 'Choose number of columns for screens between 481 and 680 px for archive lists', 'emaurri-core' ),
					'default_value' => '3',
					'options'       => emaurri_core_get_select_type_options_pool( 'columns_number' ),
					'dependency'    => array(
						'show' => array(
			...
			$tab->add_field_element(
				array(
					...
					'description'   => esc_html__( 'Choose number of columns for screens between 0 and 480 px for archive lists', 'emaurri-core' ),
					'default_value' => '3',
					'options'       => emaurri_core_get_select_type_options_pool( 'columns_number' ),
					'dependency'    => array(
						'show' => array(
			...
			$tab->add_field_element(
				array(
					...
					'description' => esc_html__( 'Enable loop for slider display of archive lists', 'emaurri-core' ),
			...
			$tab->add_field_element(
				array(
					...
					'description' => esc_html__( 'Enable autoplay for slider display of archive lists', 'emaurri-core' ),
					'options'     => emaurri_core_get_select_type_options_pool( 'yes_no' ),
					'dependency'  => array(
						'show' => array(
							'qodef_portfolio_archive_behavior' => array(
			...
			$tab->add_field_element(
				array(
					...
					'description' => esc_html__( 'Enter slider speed for slider display of archive lists', 'emaurri-core' ),
					'dependency'  => array(
						'show' => array(
							'qodef_portfolio_archive_behavior' => array(
								'values'        => 'slider',
			...
			$tab->add_field_element(
				array(
					...
					'description'   => esc_html__( 'Enable navigation for slider display of archive lists', 'emaurri-core' ),
					'default_value' => '3',
					'options'       => emaurri_core_get_select_type_options_pool( 'yes_no' ),
					'dependency'    => array(
						'show' => array(
			...
			$tab->add_field_element(
				array(
					...
					'description'   => esc_html__( 'Enable pagination for slider display of archive lists', 'emaurri-core' ),
					'default_value' => '3',
					'options'       => emaurri_core_get_select_type_options_pool( 'yes_no' ),
					'dependency'    => array(
						'show' => array(
			...
			$tab->add_field_element(
				array(
					...
					'description' => esc_html__( 'Choose pagination type for archive lists', 'emaurri-core' ),
	...
	add_action( 'emaurri_core_action_after_portfolio_options_archive', 'emaurri_core_add_portfolio_archive_list_options' );
}
