	...
	<div class="qodef-e-inner">
		...
		<div class="qodef-e-content">
			<div class="qodef-e-info qodef-info--top">
				...
				emaurri_core_theme_template_part( 'blog', 'templates/parts/post-info/category' );
			...
			<div class="qodef-e-text">
				...
				emaurri_core_theme_template_part( 'blog', 'templates/parts/post-info/excerpt', '', $params );
			...
			<div class="qodef-e-info qodef-info--bottom">
				<div class="qodef-e-info-left">
					...
					emaurri_core_theme_template_part( 'blog', 'templates/parts/post-info/read-more' );
					?>
				</div>
