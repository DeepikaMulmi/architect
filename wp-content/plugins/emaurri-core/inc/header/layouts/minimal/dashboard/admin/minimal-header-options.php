...
if ( ! function_exists( 'emaurri_core_add_minimal_header_options' ) ) {
	/**
	 ...
	 */
	function emaurri_core_add_minimal_header_options( $page, $general_header_tab ) {
	...
	add_action( 'emaurri_core_action_after_header_options_map', 'emaurri_core_add_minimal_header_options', 10, 2 );
}
