...
if ( ! function_exists( 'emaurri_core_add_minimal_centered_header_meta' ) ) {
	/**
	 * Function that add additional header layout meta box options
	 *
	 * @param object $page
	 */
	function emaurri_core_add_minimal_centered_header_meta( $page ) {
	...
	add_action( 'emaurri_core_action_after_page_header_meta_map', 'emaurri_core_add_minimal_centered_header_meta' );
}
