...
<main id="qodef-page-content" class="qodef-grid qodef-layout--template <?php echo esc_attr( emaurri_get_grid_gutter_classes() ); ?>">
	<div class="qodef-grid-inner clear">
		...
		echo apply_filters( 'emaurri_filter_search_archive_template', emaurri_get_template_part( 'search', 'templates/search' ) ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
